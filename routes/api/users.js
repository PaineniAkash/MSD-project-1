...
//@desc Register admin route (requires ADMIN_REG_CODE)
//@access Public (gated by code)
router.post('/register-admin', (req, res) => {
  ...
  if (!process.env.ADMIN_REG_CODE || req.body.adminCode !== process.env.ADMIN_REG_CODE) {
