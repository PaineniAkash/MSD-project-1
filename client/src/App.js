      ...
      <Provider store={store}>
        <Router>
          <div className="App">
            ...
            <Switch>
              <PrivateRoute exact path="/dashboard" component={RoleRedirect} />
            </Switch>
            <Switch>
              <PrivateRoute exact path="/dashboard/admin" component={Dashboard} />
            </Switch>
            <Switch>
              <PrivateRoute exact path="/dashboard/employee" component={EmployeeDashboard} />
            </Switch>
            <Switch>
            ...
            <Switch>
              <PrivateRoute exact path="/employee/upload" component={UploadEmployee} />
            </Switch>
            <Switch>
              <PrivateRoute
                exact
